...
if(process.argv.length === 2) {
  m = Number(1 + new Date().getMonth());
  y = Number(new Date().getFullYear());
} else if (process.argv.length === 3 && Number(process.argv[2]) < 13) {
  m = Number(process.argv[2]);
} else if (process.argv.length === 4 && Number(process.argv[2]) < 13 && Number(process.argv[3] < 10000 && Number(process.argv[3] > 1752))) {
  m = Number(process.argv[2]);
...
function calMaker(begS) {
  ...
  if (m === 1 || m === 3 || m === 5 || m === 7 || m === 8 || m === 10 || m === 12) {
    console.log(l5.slice(begS, begS + 20).trim() + '\n' + l6.slice(begS, begS + 20).trim());
  } else if (m === 4 || m === 6 || m === 9 || m === 11) {
    console.log(l530.slice(begS, begS + 20).trim() + '\n' + l630.slice(begS, begS + 20).trim());
  } else if (m === 2 && ((y % 400 === 0) || (y % 4 === 0 && y % 100 !== 0))) {
    console.log(l529.slice(begS, begS + 20).trim() + '\n' + l629.slice(begS, begS + 20).trim());
  } else if (m === 2 && ((y % 4 !== 0) || (y % 4 === 0 && y % 100 === 0 && y % 400 !== 0))) {
    console.log(l528.slice(begS, begS + 20).trim() + '\n' + l628.slice(begS, begS + 20).trim());
  };
}
