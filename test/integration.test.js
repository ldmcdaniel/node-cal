...
describe('month', function () {
  describe('leap february', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '2 2008').toString();
  ...
  describe('non-leap february', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '2 2007').toString();
  ...
  describe('4 week month', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '2 1998').toString();
  ...
  describe('5 week month', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '3 1999').toString();
  ...
  describe('6 week month', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '8 1980').toString();
...
describe('year', function () {
  describe('leap year', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '2004').toString();
  ...
  describe('non-leap year', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '1989').toString();
  ...
  describe('non-leap year century', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '1900').toString();
  ...
  describe('leap year century', function () {
    it('should be equal to cal', function () {
      var goalOutput = cp.execSync(platform + '2000').toString();
